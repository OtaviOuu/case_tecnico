...
config :uhedge_case_tecnico, UhedgeCaseTecnicoWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: UhedgeCaseTecnicoWeb.ErrorHTML, json: UhedgeCaseTecnicoWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: UhedgeCaseTecnico.PubSub,
  live_view: [signing_salt: "aaVztham"]
...
config :uhedge_case_tecnico, UhedgeCaseTecnico.Mailer, adapter: Swoosh.Adapters.Local
